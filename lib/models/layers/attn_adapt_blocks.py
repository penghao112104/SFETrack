...
class CEABlock(nn.Module):
    ...
    def forward_base_path(self, x, xi, global_index_template, global_index_templatei, global_index_search, global_index_searchi, mask=None, ce_template_mask=None, keep_ratio_search=None):
    ...
    def forward(self, x, xi, global_index_template, global_index_templatei, global_index_search, global_index_searchi, mask=None, ce_template_mask=None, keep_ratio_search=None):
        return self.forward_base_path(
            x,
            xi,
            global_index_template,
            global_index_templatei,
            global_index_search,
            global_index_searchi,
            mask=mask,
            ce_template_mask=ce_template_mask,
            keep_ratio_search=keep_ratio_search,
        )
