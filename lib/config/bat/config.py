...
cfg.MODEL.MOE = edict()
cfg.MODEL.MOE.ENABLE = True
cfg.MODEL.MOE.INSERT_LAYER = -1
cfg.MODEL.MOE.ALPHA = 0.7

cfg.MODEL.MOE.MAMBA_D_STATE = 16
cfg.MODEL.MOE.MAMBA_D_CONV = 4
cfg.MODEL.MOE.MAMBA_EXPAND = 2
cfg.MODEL.MOE.ROUTER_HIDDEN_RATIO = 0.25


cfg.TRAIN = edict()
cfg.TRAIN.PROMPT = edict()
cfg.TRAIN.PROMPT.TYPE = 'bat'
...
cfg.TRAIN.MOE_LR_MULTIPLIER = 1.0
cfg.TRAIN.HEAD_LR_MULTIPLIER = 1.0
...
cfg.TRAIN.MOE_SCHEDULE_MODE = 'staged'
cfg.TRAIN.MOE_STAGE_FREEZE_ALL_EPOCHS = 0

cfg.TRAIN.MOE_STAGE_START_EPOCH = 0
cfg.TRAIN.MOE_STAGE_ALL_MOE_END = 0
cfg.TRAIN.MOE_STAGE_JOINT_START = 0

cfg.TRAIN.MOE_STAGE_FREEZE_MOE_IN_JOINT = False

cfg.TRAIN.MOE_STAGE_JOINT_TRAIN_ROUTER = True
cfg.TRAIN.MOE_STAGE_FREEZE_BACKBONE = True
cfg.TRAIN.MOE_STAGE_FREEZE_BOX_HEAD = True
cfg.TRAIN.MOE_STAGE_FREEZE_ROUTER = False
cfg.TRAIN.MOE_STAGE_HEAD_LR_MULTIPLIER = 0.0
cfg.TRAIN.MOE_STAGE_FUSION_LR_MULTIPLIER = 0.0
cfg.TRAIN.MOE_ROUTER_BALANCE_WEIGHT = 0.001

cfg.TRAIN.MOE_AUX_PAST_GAP = 1
cfg.TRAIN.MOE_AUX_FUTURE_GAP = 1


cfg.TRAIN.MOE_AUX_FEATURE_WEIGHT = 0.001


cfg.TRAIN.FIX_BN = True
cfg.TRAIN.SAVE_EPOCH_INTERVAL = 0
cfg.TRAIN.SAVE_LAST_N_EPOCH = 5
...
cfg.DATA.VAL = edict()
cfg.DATA.VAL.DATASETS_NAME = ["LasHeR_val"]
...
cfg.TEST.TARGET_PRESERVATION_THRESHOLD = 0.6
